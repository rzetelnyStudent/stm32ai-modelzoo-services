...
AI_ALIGNED(32)
static ai_u8 activations_3[AI_NETWORK_DATA_ACTIVATION_3_SIZE];
...
/* -> data_out_3 is allocated in activations buffer */
...
int aiInit(void) {
  ...
  /* -> ai_output[1].data = ai_output[1].data */
  /* -> ai_output[2].data = ai_output[2].data */
