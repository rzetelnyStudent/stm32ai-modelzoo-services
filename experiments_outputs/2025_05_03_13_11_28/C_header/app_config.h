...
#define AI_OBJDETECT_YOLOVX_PP_NB_CLASSES        (80)
...
#define AI_OBJDETECT_YOLOVX_PP_CONF_THRESHOLD     (0.001)
#define AI_OBJDETECT_YOLOVX_PP_MAX_BOXES_LIMIT    (100)
#define WELCOME_MSG_1     "st_yolo_x_nano_480_1.0_0.25_3_int8.tflite"
